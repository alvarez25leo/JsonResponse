...
/**
     ...
     */
    private static function jsonWraper(array $data, int $statusCode, $readyMessageText = null)
    {
        header('Content-Type: application/json; charset=UTF-8');
        header(sprintf('HTTP/1.1 %s %s', $statusCode, $readyMessageText), true, $statusCode);
        http_response_code($statusCode);
        echo json_encode($data, 0, 512);
        die;
    }
     ...
     * @param int $responseCode
     */
    public static function error($data = null, $errorCode = null, $message = null, int $responseCode = 200)
    {
        self::jsonWraper([
            'success' => false,
            'errorCode' => $errorCode ? $errorCode : "ER".$responseCode,
    ...
    {
        return isset(self::$statusTexts[$statusCode]) ? self::$statusTexts[$statusCode] : '';
    }
